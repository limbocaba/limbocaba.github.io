    ...
    <div className=" w-full md:h-screen p-2 flex items-center py-16">
      <div className=" max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className=" col-span-2">
          ...
          <p className=" py-2 text-gray-600">When I am not coding or learning new ways to improve upon my work, I am most likely learning new openings in chess or spending time with my family and friends. I enjoy taking trips to see my family in the Dominican Republic and driving four-wheelers! </p>
        </div>
